    ...
    <div className="card weather-today">
      ...
      <div className="weather-today-layout">
        ...
        <div className="weather-today-grid">
          ...
          <span>
            ↑ {Math.round(daily.apparent_temperature_max[todayIdx])}° ↓{" "}
            {Math.round(daily.apparent_temperature_min[todayIdx])}°
          </span>
